const { useState, useEffect } = React;
    ...
    return (
        ...
        function KolektorDashboard({ user, onLogout, orders, onDailyPayment, consumers }) {
            ...
            const Layout = ({children}) => ( <div><div className="ui top attached menu"><div className="item"><i className="motorcycle big icon"></i><b>Kolektor Dashboard</b></div><div className="right menu"><div className="item"></div><div className="item"><button className="ui red button mini" onClick={onLogout}><i className="sign out icon"></i> Logout</button></div></div></div>{children}</div> );
                ...
                <div>
                    <div className="ui top attached menu">
                        ...
                        <div className="right menu">
                            ...
                            <div className="item">
                                <button className="ui red button mini" onClick={onLogout} style={{
    padding: '2px 10px',
    fontSize: '0.65rem',
    lineHeight: '1em'
  }}
